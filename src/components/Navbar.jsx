...
const Navbar = () => {
  ...
  return (
    ...
    <div className="flex items-center gap-4">
       ...
       isAuthenticated && user ? (
        ...
        <div className="relative flex items-center gap-2 cursor-pointer group">
          ...
          <div className="px-1 pr-1rem rounded-full ">
            <img className="w-8 rounded-full" src={user.image} alt="User Profile" />
          </div>
      ...
      : 
      (
        <button onClick={() => navigate('/register')} className="hidden px-8 py-3 font-light text-white rounded-full bg-blue-600 md:block cursor-pointer"> Create Account </button>
      )
      }
